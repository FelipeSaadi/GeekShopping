...
namespace GeekShopping.IdentifyServer.Initializer
{
	public class DbInitializer : IDbInitializer
	{
		...
		public void Initialize()
		{
			...
			{
				UserName = "saadi-admin",
				Email = "felipesaadisiegert@gmail.com",
				EmailConfirmed = true,
				PhoneNumber = "+55 (53) 99123-4868",
				FirstName = "Felipe",
				LastName = "Admin"
			};
			...
			_user.AddToRoleAsync(client, IdentityConfiguration.Admin)
				.GetAwaiter().GetResult();
